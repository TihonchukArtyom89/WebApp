...
public static class SeedData
{
    public static void SeedDatabase(DataContext context)
    {
        ...
        if (context.Products.Count() == 0 && context.Suppliers.Count() == 0 && context.Categories.Count() == 0)
        {
            ...
            Supplier s2 = new Supplier { Name = "Soccer Town", City = "Chicage" };
            ...
            context.AddRange(
                ...
                new Product { Name = "Soccer Bal", Price = 19.50m, Category = c2, Supplier = s2 },
                ...
                new Product { Name = "Thinking Cap", Price = 19.50m, Category = c3, Supplier = s3 },
